  ...
  <div class="main">
    ...
    <div class="content">
      <div class="greeting">
        ...
        <div class="greeting-sub">Monday, Jun 26 · ${Store.getCurrentLocation() ? Store.getCurrentLocation().name : (_isSupervisor ? 'All locations' : '—')} · ${activeCount} active work order${activeCount !== 1 ? 's' : ''}</div>
      </div>
