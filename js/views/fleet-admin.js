...
/* ── Avatar ── */
.fa-avatar { width:36px; height:36px; border-radius:50%; background:#1E1E1E; color:#00843D; font-size:12px; font-weight:700; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
