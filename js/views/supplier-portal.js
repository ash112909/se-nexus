...
.man-vendor-item.active .mvi-icon { background:#1C3969; color:#0A1628; }
...
.doc-btn-primary { background:#1C3969; border:none; color:#0A1628; font-weight:600; }
...
.pc-drop-item.active .pc-drop-logo { background:#1C3969; color:#0A1628; }
