function render_recommended(el) {
  ...
  el.innerHTML = '<style>'
    ...
    + '.rec-cart-btn{display:none;align-items:center;gap:6px;background:#1F6B22;border:none;border-radius:8px;padding:7px 14px;font-size:12px;font-weight:600;color:#FFFFFF;cursor:pointer;font-family:inherit;flex-shrink:0;margin-top:2px;}'
