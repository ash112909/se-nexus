function render_recommended(el) {
  ...
  var REASON_STYLES = {
    'wo':        { bg: '#D6E4F7', color: '#1C3969', border: '#1C3969' },
  ...
  var CAT_META = {
    ...
    'Hydraulic':   { icon: 'ti-droplet',        color: '#1C3969', bg: '#D6E4F7' },
    ...
    'Filtration':  { icon: 'ti-filter',         color: '#1C3969', bg: '#E1F5EE' },
  };
  ...
  function doAddToCart(partId) {
    ...
    Modal.show({
      ...
      body: '<div style="display:flex;flex-direction:column;gap:12px;">'
        ...
        + '<i class="ti ti-alert-triangle" style="font-size:16px;color:#1C3969;flex-shrink:0;margin-top:1px;"></i>'
  ...
  function reasonHtml(partId) {
    var r = PART_REASONS[partId];
    if (!r) return '<div class="part-card-reason"><i class="ti ti-sparkles" style="color:#1C3969;flex-shrink:0;margin-top:1px;"></i><span>Recommended for your fleet</span></div>';
  ...
  el.innerHTML = '<style>'
    ...
    + '.rec-cart-btn{display:none;align-items:center;gap:6px;background:#152B52;border:none;border-radius:8px;padding:7px 14px;font-size:12px;font-weight:600;color:#FFFFFF;cursor:pointer;font-family:inherit;flex-shrink:0;margin-top:2px;}'
    ...
    + '<span class="rec-legend-item"><span class="rec-legend-dot" style="background:#1C3969;"></span>Active WO</span>'
  ...
  (function renderVendorChip() {
    ...
    chip.innerHTML = '<span style="font-size:11px;color:#7A7F8E;">Filtered by:</span>'
      + '<span style="display:inline-flex;align-items:center;gap:5px;background:#D6E4F7;border:0.5px solid #1C3969;border-radius:100px;padding:3px 10px;font-size:12px;font-weight:600;color:#1C3969;">'
      + '<i class="ti ti-building-store" style="font-size:11px;"></i>' + _vendorFilter
      + '<button onclick="recClearVendor()" style="background:none;border:none;padding:0;margin-left:2px;cursor:pointer;color:#1C3969;font-size:14px;line-height:1;display:flex;align-items:center;" title="Remove filter">×</button>'
      + '</span>';
