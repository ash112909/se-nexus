function render_recommended(el) {
  ...
  function renderRecommendedParts() {
    ...
    if (!container) return;
    var parts = Store.getParts('', '').filter(function(p) { return p.recommended; }).slice(0, 6);
