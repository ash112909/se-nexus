function render_parts_search(el) {
  ...
  const SUPPLIER_PROFILES = {
    'SKJ': {
      ...
      color: '#00843D',
      logo: `<svg width="180" height="48" viewBox="0 0 180 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="180" height="48" rx="4" fill="#1E1E1E"/><text x="14" y="32" font-size="22" font-weight="800" font-family="Inter,sans-serif" fill="#00843D" letter-spacing="-0.5">SKYJACK</text></svg>`,
...
.slp-body{display:flex;gap:18px;padding:18px;align-items:flex-start;flex:1;width:100%;}
...
.slp-cat-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:10px;width:100%;}
...
.slp-action-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:8px;width:100%;}
