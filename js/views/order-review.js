function render_order_review(el) {
  ...
  if (!wo || !itemIds.length) {
    el.innerHTML = `<div class="shell">${buildSidebar('wo')}<div class="main"><div style="padding:40px;color:#9CA3AF;font-size:14px;">No order data. <a style="color:#00843D;cursor:pointer;" onclick="history.back()">Go back</a></div></div></div>`;
    return;
  }
  ...
  function recBadgeColor(badge) {
    ...
    if (badge === 'Expedited') return 'background:#E6F4EC;color:#1B5E35;border:0.5px solid #00843D;';
...
.or-return-btn:hover { background:#E6F4EC; color:#1B5E35; }
...
.or-input:focus { border-color:#00843D; background:#FFFFFF; }
...
.or-textarea:focus { border-color:#00843D; background:#FFFFFF; }
/* Options grid */
...
.or-select:focus { border-color:#00843D; }
/* Shipping rec */
...
.or-btn-primary { background:#00843D; border:none; border-radius:8px; padding:9px 20px; font-size:13px; font-weight:600; color:#0D2E18; cursor:pointer; font-family:inherit; display:inline-flex; align-items:center; gap:6px; }
.or-btn-primary:hover { background:#006830; }
  ...
  <div class="main" style="display:flex;flex-direction:column;overflow:hidden;">
    ...
    <div style="flex:1;overflow-y:auto;">
      <div class="or-content">
        ...
        <div class="or-card">
          <div class="or-card-header">
            <div class="or-card-title"><i class="ti ti-list" style="font-size:15px;color:#00843D;"></i> Order items</div>
