...
(function() {
  const FLEET_ASSETS = [
    ...
    {
      id: 'FL-061', companyCode: 'MCR', equipNum: 'FL-061',
      type: 'Aerial Work Platform', category: 'Articulating Boom', class: 'Diesel',
      location: 'Austin Branch', make: 'JLG', model: '600AJ',
      serial: 'JLG600AJ-00488', status: 'Active', year: 2020,
      acquisitionDate: 'Mar 12, 2020', retiredDate: null,
      warrantyEnd: 'Mar 12, 2023', hours: 1422, mileage: null,
      description: '60 ft articulating boom lift. 4WD diesel, 500 lb platform capacity.',
      image: null,
      manualMachines: [],
    },
    {
      id: 'FL-078', companyCode: 'MCR', equipNum: 'FL-078',
      type: 'Material Handler', category: 'Telehandler', class: 'Diesel',
      location: 'San Marcos Branch', make: 'Caterpillar', model: 'TH407',
      serial: 'CATTR407-00312', status: 'Active', year: 2021,
      acquisitionDate: 'Nov 5, 2021', retiredDate: null,
      warrantyEnd: 'Nov 5, 2024', hours: 2110, mileage: null,
      description: '7,000 lb telehandler, 42 ft max lift height. Side-shift carriage.',
      image: null,
      manualMachines: [],
    },
    {
      id: 'FL-022', companyCode: 'MCR', equipNum: 'FL-022',
      type: 'Aerial Work Platform', category: 'Scissor Lift', class: 'Electric',
      location: 'Kyle Branch', make: 'Skyjack', model: 'SJIII 4632',
      serial: 'SJ4632-00294', status: 'Active', year: 2017,
      acquisitionDate: 'Jul 19, 2017', retiredDate: null,
      warrantyEnd: null, hours: 3860, mileage: null,
      description: '32 ft electric scissor lift. Outdoor-rated, self-leveling outriggers.',
      image: null,
      manualMachines: ['Skyjack SJIII 4632'],
    },
    {
      id: 'FL-047', companyCode: 'MCR', equipNum: 'FL-047',
      type: 'Forklift', category: 'Counterbalance Forklift', class: 'Electric',
      location: 'Austin Branch', make: 'Toyota', model: '8FBU32',
      serial: 'TOY8FBU32-00552', status: 'Active', year: 2022,
      acquisitionDate: 'Apr 8, 2022', retiredDate: null,
      warrantyEnd: 'Apr 8, 2025', hours: 1180, mileage: null,
      description: '7,000 lb electric counterbalance forklift. 186" max lift, cold-storage rated.',
      image: null,
      manualMachines: [],
    },
    {
      id: 'FL-088', companyCode: 'MCR', equipNum: 'FL-088',
      type: 'Compact Track Loader', category: 'Skid Steer / CTL', class: 'Diesel',
      location: 'San Marcos Branch', make: 'Bobcat', model: 'T650',
      serial: 'BOB-T650-00973', status: 'In Service', year: 2019,
      acquisitionDate: 'Aug 22, 2019', retiredDate: null,
      warrantyEnd: null, hours: 4330, mileage: null,
      description: 'Mid-size track loader with two-speed drive. Bucket and auger attachments.',
      image: null,
      manualMachines: [],
    },
    {
      id: 'FL-011', companyCode: 'MCR', equipNum: 'FL-011',
      type: 'Aerial Work Platform', category: 'Scissor Lift', class: 'Electric',
      location: 'Kyle Branch', make: 'Genie', model: 'GS-3246',
      serial: 'GEN-GS3246-00618', status: 'Retired', year: 2010,
      acquisitionDate: 'Feb 3, 2010', retiredDate: 'Mar 15, 2024',
      warrantyEnd: null, hours: 9820, mileage: null,
      description: '32 ft narrow-aisle scissor lift. Retired — scissor arm fatigue crack found in annual inspection.',
      image: null,
      manualMachines: [],
    },
    {
      id: 'FL-066', companyCode: 'MCR', equipNum: 'FL-066',
      type: 'Excavator', category: 'Tracked Excavator', class: 'Diesel',
      location: 'Kyle Branch', make: 'Caterpillar', model: '308 CR',
      serial: 'CAT308CR-00741', status: 'Active', year: 2022,
      acquisitionDate: 'Jan 18, 2022', retiredDate: null,
      warrantyEnd: 'Jan 18, 2025', hours: 1640, mileage: null,
      description: '8-ton compact radius excavator. 18" bucket, quick coupler, cab w/ A/C.',
      image: null,
      manualMachines: [],
    },
  ];
